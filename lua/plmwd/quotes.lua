...
---@param source? string
---@return string
function quotes.random(source)
    source = source or vim.tbl_keys(quotes.sources)[math.random(#quotes.sources)]
    return quotes.sources[source][math.random(#quotes.sources[source])] .. ' — ' .. source
end
